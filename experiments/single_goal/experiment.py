...
towards a specified goal in the scene. Communication between the Nengo model
and V-REP is handled using the V-REP remote API.
...
saved_params = [
    ...
    'goal', 'init_global_vec', 'nengo_backend', 'nengo_sim_dt', 'np_seed',
